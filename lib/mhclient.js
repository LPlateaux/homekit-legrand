...
class MyHomeClient {
    ...
    simpleBlindCommand(_address,_stopUpDown) {
        ...
        if (_stopUpDown != 0) {
 //           this._bufferCommand("SIMPLEBLIND",address,sprintf("*2*%d*%s##",0,address),500);
          this.command.send(sprintf("*2*%d*%s##",0,address));
        }
//        this._bufferCommand("SIMPLEBLIND",address,sprintf("*2*%d*%s##",parseInt(_stopUpDown),address),500);
